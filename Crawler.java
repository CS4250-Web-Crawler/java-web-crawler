...
public class Crawler {
    ...
    public static final int MAX_CRAWL_COUNT = 3;
    public static final String EN_PRIMARY_SEED = "https://www.espn.com/nba/";
    ...
    public static HashMap<String, Integer> inlinkCollection; //update: check if outlink is already in outlink hashmap
            ...
            try {
                ...
                if (detectedLanguage.toString().equals(lang)) {
                    ...
                    for (Element page : linksOnPage) {
                        if(page.attr("abs:href").contains("espn.com/nba")) {
                            outlinksCount++;
                            String plainUrl = page.attr("abs:href");
                            //is url already in linkCollection
                            if(linkCollection.containsKey(plainUrl)){
                                //add link to inLinkCollection
                                inlinkCollection.put(plainUrl,0);
                                inLinkCount++;
                            }
                    ...
                    //update inLink with number of inLinks to current url
                    inlinkCollection.put(url, inLinkCount);
                } else {
    ...
    public static void writeToCSV(HashMap<String, Integer> linkCollection, HashMap<String, Integer> inLinkCollection, String lang) throws IOException{
        // create csv file
        ...
        for (HashMap.Entry<String, Integer> entry: inLinkCollection.entrySet()) {
            output.write(entry.getKey() + " , " + entry.getValue() + "\n");
        }
        output.close();
    }
    ...
    public static void main(String[] args) throws IOException{
        ...
        writeToCSV(linkCollection, inlinkCollection, EN);
